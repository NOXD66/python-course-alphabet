class Cat:
    ...
    * Implement get_average_speed and return average_speed
    ...
    def run(self, hours):
        ran_km = hours * self.get_average_speed()
        if 50 >= ran_km > 25:
...
class Wall:
    ...
    * Implement method number_of_rolls_of_wallpaper which receives such parameters: roll_width_m, roll_length_m
    ...
    def number_of_rolls_of_wallpaper(self, roll_width_m, roll_length_m):
        ...
        count_of_lines_wall = self.width // roll_width_m
        count_rolls = count_of_lines_wall / count_of_lines_roll
        return count_rolls
...
class House:
    ...
    * Implement method get_room_square that returns the square of our room
    ...
    def get_walls_square(self):
        return sum(list(x.wall_square() for x in self.__walls))

    def get_windows_square(self):
        return sum(list(x.window_square() for x in self.__windows))
    ...
    def get_number_of_rolls_of_wallpapers(self, roll_width_m, roll_length_m):
        try:
            if roll_width_m <= 0 or roll_length_m <= 0:
                ...
                return sum(list(x.number_of_rolls_of_wallpaper(roll_width_m, roll_length_m) for x in self.__walls))
        except Exception as err:
            raise err
